...
func (rm *RabbitMQMetrics) Print() string {
	return fmt.Sprintf("## job: %s,instance: %s,runnningNodes: %d,runningNodesBefore1Day: %d,runningNodesBefore1Week: %d", rm.job, rm.instance, rm.runningNodesUsage, rm.before1DayRunningNodesUsage, rm.before1WeekRunningNodesUsage)
}
