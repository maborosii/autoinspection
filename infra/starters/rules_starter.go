...
// type addRulesFunc func(rs.RuleItf)
// type addRulesMap map[string]addRulesFunc

// var rulesMap = addRulesMap{}

// // register handle
// func (a addRulesMap) registerRuleType(ruleType string, f addRulesFunc) error {
// 	if _, exists := rulesMap[ruleType]; exists {
// 		return fmt.Errorf("%s has been registered", ruleType)
// 	}
// 	a[ruleType] = f
// 	return nil
// }
